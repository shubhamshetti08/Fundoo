      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          active || completed ? _react2.default.createElement(
            'a',
            { className: 'stepper-circle-completed', href: href, onClick: onClick, style: styles.index },
            stepContent
          ) : _react2.default.createElement(
            'span',
            { className: 'stepper-circle-unstarted', style: styles.index },
            stepContent
          )
        ),
        active || completed ? _react2.default.createElement(
          'a',
          { className: 'stepper-title-completed', href: href, onClick: onClick, style: titleStyle },
          title
        ) : _react2.default.createElement(
          'div',
          { className: 'stepper-title-unstarted', style: titleStyle },
          title
        ),
